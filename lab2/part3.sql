...
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(3, 'Marketing', 200, 'University Av W', 'Waterloo', 'ON', 'N2L3G1');
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(7, 'Research', 10, 'Victoria St A', 'Kitchener', 'ON', 'N2G1C5');
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(12, 'Software', 27, 'King College Cir', 'Toronto', 'ON', 'M5S5R5');
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(13, 'Computing', 1265, 'Military Trail', 'Scarborough', 'ON', 'M1C14A');
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(24, 'Training', 27, 'King College Cir', 'Toronto', 'ON', 'M5S5R5');
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(25, 'Human Resources', 1265, 'Military Trail', 'Scarborough', 'ON', 'M1C14A');
INSERT INTO Department(deptID, deptName, streetNum, streetName, cityName, province, postalCode) VALUES(27, 'Food Services', 1265, 'Military Trail', 'Scarborough', 'ON', 'M1C14A');
